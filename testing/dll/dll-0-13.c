...
main(void)
    ...
    printf("value at 6683 is %d\n",getINTEGER(getDLL(p,6683)));
    printf("setting value at 6683 to 52\n");
    freeINTEGER(setDLL(p,6683,newINTEGER(52)));
    printf("value at 6683 now is %d\n",getINTEGER(getDLL(p,6683)));
    freeDLL(p);
    freeDLL(q);
    return 0;
    }
